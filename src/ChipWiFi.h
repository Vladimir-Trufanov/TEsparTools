 ...
 * 
 *          Обеспечить поиск и подключение к одной из сетей WiFi в соответствии 
 *     с массивом учетных записей возможных локальных сетей, обработать события 
 *                            подключения, создать собственную сеть контроллера
 * 
 * v1.0.5, 26.03.2026                                 Автор:      Труфанов В.Е.
