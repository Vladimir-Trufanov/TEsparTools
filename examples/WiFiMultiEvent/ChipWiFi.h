...
#define ChipWiFiEvent WiFi.onEvent
  ...
  //ochipWiFi.addAP("OPPO A9 2020",  "b277a4ee84e8");
  //ochipWiFi.addAP("tve-MONOBLOCK", "Ue18-647");
  //ochipWiFi.addAP("linksystve",    "X93K6KQ6WF");
...
/*
// Определяем массив учетных записей возможных локальных сетей
int narr = 12;        // число элементов в массиве
const char* sarr[] =  // массив учетных данных
{
  "TP-Link_B394",  "18009217",
